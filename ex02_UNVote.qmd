...
The code below compares the voting record of three countries: US, UK and Turkey. Change the code so as to compare between a different set of countries. What do you conclude?
