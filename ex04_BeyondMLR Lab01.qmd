...
**Answer:** Observational units 👀 = XXXXXXX bank workers 👷;\
...
# This chunk is just me playing around. 
...
**Answer:** 
- Linearity = residuals vs fitted values has small curvature around 0 -- slight evidence of quadratic effect. 
...
**Answer** Males had XXXXX% (exp(XXXXX) = XXXXX) higher  salaries than females,after controlling for seniority, education, and experience (diagnostics look
good for both 3 and 3a).
